...
const WeeklyOfferAccessCard = () => {
  ...
  return (
    <section className="rounded-3xl border-2 border-caramel/25 bg-gradient-to-br from-white via-butter/25 to-caramel/10 p-5 text-center shadow-sm">
      <div className="mb-3 flex items-center justify-center gap-2"><LockOpen className="h-5 w-5 text-caramel" /><h2 className="font-display text-xl font-black text-espresso">Votre accès à la proposition du moment</h2></div>
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        ...
        <Button asChild className="h-11 rounded-xl"><a href={accessUrl}><QrCode className="mr-2 h-4 w-4" />Voir la proposition du moment</a></Button>
      </div>
    </section>
  );
};
