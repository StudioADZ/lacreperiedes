    ...
    "disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        /**
         * ✅ NEW — CTA “Hero” (micro-animations)
         * - n’écrase pas default
         * - garde un look premium + dynamique
         * - animations simples et safe (hover/active)
         */
        hero:
...
export interface ButtonProps
  ...
  /**
   * ✅ NEW — loading mode (optionnel)
   * - évite double clics
   * - n’impose rien si tu ne l’utilises pas
   */
  loading?: boolean;
}
