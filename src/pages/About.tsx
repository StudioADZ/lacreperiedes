  ...
  return (
    <div className="min-h-screen pt-20 pb-24 px-4">
      <div className="max-w-lg mx-auto">
        ...
        >
          <div className="card-warm text-center">
            <div className="w-28 h-28 rounded-full overflow-hidden mx-auto mb-4 shadow-warm border-4 border-butter">
              <img src={logo} alt="Amatekoe - Fondateur" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="text-muted-foreground font-serif leading-relaxed space-y-4 text-left">
              <p>
                Né à <strong className="text-foreground">Lomé, au Togo</strong>, Amatekoe arrive en France en 1997 
                avec un rêve : partager sa passion pour la cuisine et créer un lieu chaleureux où 
                chaque client se sent comme chez lui.
              </p>
              <p>
                Après plus de <strong className="text-foreground">12 années d'expérience</strong> dans la restauration, 
                il fonde La Crêperie des Saveurs à Mamers. Chaque crêpe et galette est préparée 
                avec un savoir-faire artisanal, mêlant traditions bretonnes et touches personnelles.
              </p>
              <p>
                Son parcours est une histoire de <strong className="text-foreground">résilience et de passion</strong> – 
                un témoignage que les rêves peuvent se réaliser avec du travail et de la détermination.
              </p>
            </div>
          </div>
        </motion.section>
        ...
        >
          <h2 className="font-display text-xl font-semibold mb-4 text-center">Nos valeurs</h2>
