...
const TikTokIcon = ({ className = "w-6 h-6" }: IconProps) => (
...
const Social = () => {
  const socials: Array<{
  ...
  }> = [
    {
      ...
      ariaLabel: "Ouvrir Instagram (nouvel onglet)",
    },
    {
      name: "Facebook",
      handle: "La Crêperie des Saveurs",
      url: "https://www.facebook.com/profile.php?id=61564140770538",
      icon: Facebook,
      color: "bg-[#1877F2]",
      description: "Actualités et événements",
      ariaLabel: "Ouvrir Facebook (nouvel onglet)",
    },
    {
      name: "TikTok",
      ...
      ariaLabel: "Ouvrir TikTok (nouvel onglet)",
    },
    {
      name: "YouTube",
      handle: "LA CRÊPERIE DES SAVEURS",
      url: "https://www.youtube.com/@LACR%C3%8APERIEDESSAVEURS",
      icon: Youtube,
      color: "bg-[#FF0000]",
      description: "Recettes et reportages",
      ariaLabel: "Ouvrir YouTube (nouvel onglet)",
    },
  ];
    ...
    <div className="min-h-screen pt-20 pb-24 px-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-3xl font-bold mb-3">Suivez-nous !</h1>
        ...
        {/* Preview */}
        <div className="mb-3">
          <h2 className="font-display text-lg font-semibold text-center">Aperçu</h2>
          <p className="text-xs text-muted-foreground text-center mt-1">
            Dernières actus et contenus récents
          </p>
        </div>

        {/* Network Preview Cards (conservé tel quel) */}
        ...
        <div className="space-y-4">
          <h2 className="font-display text-lg font-semibold text-center mb-4">Tous nos réseaux</h2>
              ...
              >
                <div className="card-warm hover:shadow-warm transition-all duration-300 group">
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-14 h-14 rounded-2xl ${social.color} flex items-center justify-center flex-shrink-0 text-white`}
                      aria-hidden="true"
                    >
        ...
        <div className="mt-8">
          <a
            ...
            rel="noopener noreferrer"
            className="block"
            aria-label="Rejoindre la communauté WhatsApp (nouvel onglet)"
          >
